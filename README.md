...
**Python Data Analytics** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_NarimanAlimuradov/tree/master/python_data_analytics)]: Analyzed Jarvis's client's (London Gift Shop's) retail data to determine the causes of their recent decline in sales. Used statistical techniques to establish solutions for retaining old customers, as well as attracting new ones. Analyses performed in Python and saved in a Jupyter notebook. Uses Pandas, NumPy, and MatPlotLib for data wrangling and visualization. Stored client data in a data warehouse using PostgreSQL.
